...
{ name:"Cookie Stand",
  ...
  body:"<p>A sample of a front facing retail website with web application that forecasts the cookies sold per location.</p>",
  img:"data/img/salmoncookies.png",
  ...
  { name:"Seattle Adventure",
    ...
    img:"data/img/seattleAdventure.png",
    category:"game"},
